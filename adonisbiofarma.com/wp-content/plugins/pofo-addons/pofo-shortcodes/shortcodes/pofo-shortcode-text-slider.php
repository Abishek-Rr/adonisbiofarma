        ...
        if( ! empty( $pofo_text_slides ) ) {
            ...
            switch ($text_slider_style) {
                case 'pofo-text-slider1':
            		...
            		$output .='<div id="'.esc_attr( $pofo_slider_id ) .'" class="swiper-container swiper-number-pagination swiper-container-horizontal '.$pofo_slider_id.' '.$pofo_show_cursor_color_style.$pofo_slider_class.'">';
                ...
                case 'pofo-text-slider2':
                    ...
                    $output .='<div id="'.esc_attr( $pofo_slider_id ) .'" class="swiper-container text-center content-right-slider text-slider-style2-'.$pofo_text_slider_style2.' '.$pofo_slider_id.' '.$pofo_show_cursor_color_style.$pofo_slider_class.'">';
                        $output .='<div class="swiper-wrapper">';
